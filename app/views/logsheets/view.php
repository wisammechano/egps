...
<div class="view-box">
	...
	<form id="viewLS" class="validate" method="post" action="./view">
		<div class="table">
			...
			<?php foreach($parsed as $sub => $details):?>
			<div class="subSys">
				...
				<div class="row center-text heads">
					<?php $span = 4; foreach ($theads as $thead):?>
					<?php if($thead === 'tag') $span=2;?>
					<?php if($thead != 'type'):?>
					<div class="cell col-xs-<?php echo $span;?>"><?php echo $mob? ucfirst(shorten($thead, 'heads')):ucfirst($thead)?></div>
